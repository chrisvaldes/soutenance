        ...
        <div class="col-8">
            <div class="card">
                <div class="card-title">
                    <h4 class="text-center">ETAT DE SERVICES FAITS DES PRESTATIONS DES SOUENANCES DES MEMOIRES DE FIN D'ETUDE INGENIEUR</h4>
                            ...
                            <tr>
                                <th colspan="1" class="text-center">
                                    <form action="{{ route('file.export') }}" method="POST"
                                        ...
                                        @csrf
                                        <a class="btn btn-success me-3" href="{{route('departement.bilan_intervention')}}">Retour</a>
